...
const relatedLinks = [
  { href: '/', label: 'Découvrir Cap Revenu' },
...
export function CalculRevenuAutoEntrepreneurPage() {
  return (
    <SeoContentPage
      metadata={{
        title: 'Calcul revenu auto-entrepreneur : estimer son chiffre d’affaires | Cap Revenu',
        description:
          'Estimez combien gagner en auto-entrepreneur et quel chiffre d’affaires viser pour atteindre votre revenu mensuel avec Cap Revenu.',
      }}
      ...
      intro="Cap Revenu vous aide à estimer combien gagner en auto-entrepreneur selon votre objectif net, votre activité et votre rythme mensuel. Vous visualisez plus rapidement le chiffre d’affaires à encaisser pour atteindre un revenu réaliste."
      sections={[
        {
          ...
          paragraphs: [
            ...
            'Cap Revenu vous aide à transformer ce calcul en objectif concret, lisible et facile à suivre chaque mois.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Cap Revenu a été conçu pour rendre cette lecture simple, rapide et actionnable.',
          ],
        },
      ]}
...
export function CombienCaPour3000NetPage() {
  return (
    <SeoContentPage
      metadata={{
        title: 'Combien de chiffre d’affaires pour 3000€ net ? | Cap Revenu',
        description:
          'Découvrez combien de chiffre d’affaires viser pour atteindre 3000€ net par mois et pilotez votre objectif avec Cap Revenu.',
      }}
      eyebrow="Objectif de revenu mensuel"
      title="Combien de chiffre d’affaires faut-il pour atteindre 3000€ net par mois ?"
      intro="Pour atteindre 3000€ net, il faut raisonner à partir de votre statut, de vos prélèvements et du chiffre d’affaires réellement encaissé. Cap Revenu vous permet de transformer cet objectif en trajectoire mensuelle claire."
      sections={[
        {
          ...
          paragraphs: [
            ...
            'Cap Revenu permet de visualiser cette différence immédiatement.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Avec Cap Revenu, vous reliez directement votre revenu cible à votre progression mensuelle. Vous voyez rapidement si vous êtes en avance, au bon niveau ou en retard.',
...
export function SimulateurRevenuFreelancePage() {
  return (
    <SeoContentPage
      metadata={{
        title: 'Simulateur revenu freelance : calculez votre objectif mensuel | Cap Revenu',
        description:
          'Utilisez un simulateur de revenu freelance pour savoir combien encaisser chaque mois et atteindre votre objectif de revenu avec Cap Revenu.',
      }}
      ...
      intro="Cap Revenu est un simulateur de revenu pour indépendants qui vous aide à savoir combien encaisser pour atteindre votre objectif mensuel. Vous partez de votre revenu cible et obtenez une lecture claire de votre trajectoire."
      sections={[
        {
          ...
          paragraphs: [
            ...
            'Cap Revenu a été conçu pour rendre ce pilotage simple et compréhensible.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'C’est précisément la logique de Cap Revenu.',
          ],
        },
      ]}
      relatedLinks={relatedLinks}
